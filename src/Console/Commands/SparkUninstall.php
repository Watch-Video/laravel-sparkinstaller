<?php namespace GeneaLabs\LaravelSparksInstaller\Console\Commands;

use Illuminate\Console\Command;
use Illuminate\Filesystem\Filesystem;
use Symfony\Component\Process\Process;

class SparkDowngrade extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'spark:downgrade {--force}';
     ...
     * @var string
     */
    protected $description = 'Remove the Spark scaffolding from the application';
